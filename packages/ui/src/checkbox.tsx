  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="flex items-center justify-center text-current transition-none [&>svg]:hidden data-[state=checked]:[&>svg[data-icon=check]]:block data-[state=indeterminate]:[&>svg[data-icon=minus]]:block"
      >
        <CheckIcon data-icon="check" className="stroke-3 size-3 text-white" />
        <MinusIcon data-icon="minus" className="stroke-3 size-3 text-white" />
      </CheckboxPrimitive.Indicator>
    </CheckboxPrimitive.Root>
  );
}
